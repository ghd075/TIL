...
<%
	String up_url = request.getContextPath() + "/"
			+ (request.getParameter("up_dir") != null ? request.getParameter("up_dir") : "/images"); // 기본 업로드 URL
	String up_dir = request.getParameter("up_dir") != null ? request.getParameter("up_dir") : "/images";
	//기본 업로드 폴더
